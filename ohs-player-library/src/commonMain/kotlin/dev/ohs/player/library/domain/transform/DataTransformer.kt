 ...
 *
 * Evaluates each FhirPath expression declared in the ViewDefinition columns against
 * the provided resource, then decodes the resulting values into an instance of [T].
 *
 * Example:
 * ```kotlin
...
class DataTransformer(
    ...
    /**
     * Evaluates each FhirPath column in [viewDefinition] against [resource]
