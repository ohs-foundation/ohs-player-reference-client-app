 ...
 * [dev.ohs.player.library.registry.ViewType] registrations with different configs —
 * e.g. a patient card rendered both as a list card and as a detail header with
 * `showLastVisit = false`.
 *
 * ```
 ...
 *
 * Each invocation produces a fresh [ConfiguredRenderer] instance — they are not cached
 * or value-equal. Callers needing identity (e.g. for tests) should retrieve the original
